...
<iframe width="640" height="360" src="https://www.youtube.com/embed/qFmWDZvA7-0?si=mVpKWmLm4AmPqLrb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="640" height="360" src="https://docs.google.com/presentation/d/1O0OXV6T6qxyzz66eoYKZEtY4H8JqrxIF/preview" allow="autoplay"></iframe>  
...
```{python, eval=FALSE, attr.source='.numberLines'}
from tqdm import tqdm # this draws progress bars for us

reads_dir = LIB/"inputs/reads"
samples = list(reads_dir.iterdir())
```

**Quantification will take about 20 minutes. Do not run.**
